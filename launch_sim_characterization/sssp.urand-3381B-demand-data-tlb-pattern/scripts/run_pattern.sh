...
TRACE="${TRACE:-/data2/zcq/champsim_traces_gap/sssp.urand-3381B.champsimtrace.xz}"
TRACE_TAG="${TRACE_TAG:-sssp.urand-3381B}"
N_WARM="${N_WARM:-50}"
N_SIM="${N_SIM:-100}"
MAX_EVENTS="${MAX_EVENTS:-0}"
SKIP_EXISTING="${SKIP_EXISTING:-1}"
BINARY_NAME="sssp.urand-3381B-demand-tlb-pattern-1core"
