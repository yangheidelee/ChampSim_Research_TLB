...
PERMIT_LOG = CASE_DIR / "result" / "l1pref" / f"{TRACE_TAG}-gcc-footprint-l1pref-1core.log"
DISCARD_LOG = CASE_DIR / "result" / "discard_pgc" / f"{TRACE_TAG}-gcc-footprint-discard-pgc-1core.log"
