...
TRACE_TAG="${TRACE_TAG:-602.gcc_s-2226B}"
N_WARM="${N_WARM:-1}"
N_SIM="${N_SIM:-1}"
SKIP_EXISTING="${SKIP_EXISTING:-1}"
DO_BUILD="${DO_BUILD:-1}"

NOL1PREF_CONFIG="${SCRIPT_DIR}/1C.nol1pref.gcc-footprint.json"
L1PREF_CONFIG="${SCRIPT_DIR}/1C.l1pref.gcc-footprint.json"
NOL1PREF_BIN="gcc-footprint-nol1pref-1core"
L1PREF_BIN="gcc-footprint-l1pref-1core"
