# 433.milc-127B Demand Data TLB Pattern
...
./launch_sim_characterization/433.milc-127B-demand-data-tlb-pattern/scripts/run_all.sh all
```
...
./launch_sim_characterization/433.milc-127B-demand-data-tlb-pattern/scripts/run_all.sh smoke
```

只重新后处理：

```bash
./launch_sim_characterization/433.milc-127B-demand-data-tlb-pattern/scripts/run_all.sh analyze
```
