# SPEC17 fotonik3d L1D/STLB Footprint Characterization

这个 case 固定跑 SPEC17 `649.fotonik3d_s-10881B` trace，用两个 ChampSim JSON 配置生成两个 bin：
...
```text
/data0/tzh/champsim_traces/SPEC17/649.fotonik3d_s-10881B.champsimtrace.xz
```
...
```bash
cd /home/zcq/git_prj/ChampSim/launch_sim_characterization/fotonik3d-l1pref-stlb-footprint
