...
TRACE="${TRACE:-/data0/tzh/champsim_traces/SPEC17/649.fotonik3d_s-10881B.champsimtrace.xz}"
TRACE_TAG="${TRACE_TAG:-649.fotonik3d_s-10881B}"
N_WARM="${N_WARM:-1}"
N_SIM="${N_SIM:-1}"
SKIP_EXISTING="${SKIP_EXISTING:-1}"
DO_BUILD="${DO_BUILD:-1}"

NOL1PREF_CONFIG="${SCRIPT_DIR}/1C.nol1pref.fotonik3d-footprint.json"
L1PREF_CONFIG="${SCRIPT_DIR}/1C.l1pref.fotonik3d-footprint.json"
NOL1PREF_BIN="fotonik3d-footprint-nol1pref-1core"
L1PREF_BIN="fotonik3d-footprint-l1pref-1core"
