...
TRACE_TAG = "605.mcf_s-1536B"

PERMIT_LOG = CASE_DIR / "result" / "l1pref" / f"{TRACE_TAG}-mcf-footprint-l1pref-1core.log"
DISCARD_LOG = CASE_DIR / "result" / "discard_pgc" / f"{TRACE_TAG}-mcf-footprint-discard-pgc-1core.log"
