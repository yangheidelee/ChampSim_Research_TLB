...
NOL1PREF_CONFIG="${SCRIPT_DIR}/1C.nol1pref.mcf-footprint.json"
L1PREF_CONFIG="${SCRIPT_DIR}/1C.l1pref.mcf-footprint.json"
NOL1PREF_BIN="mcf-footprint-nol1pref-1core"
L1PREF_BIN="mcf-footprint-l1pref-1core"
