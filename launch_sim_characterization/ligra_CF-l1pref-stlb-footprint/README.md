# Ligra CF L1D/STLB Footprint Characterization

这个 case 固定跑 Ligra `ligra_CF.com-lj.ungraph.gcc_6.3.0_O3.drop_184750M.length_250M` trace，用两个 ChampSim JSON 配置生成两个 bin：
...
```bash
cd /home/zcq/git_prj/ChampSim/launch_sim_characterization/ligra_CF-l1pref-stlb-footprint
