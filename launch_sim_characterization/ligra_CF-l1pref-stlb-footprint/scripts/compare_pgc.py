...
TRACE_TAG = "ligra_CF.com-lj.ungraph.gcc_6.3.0_O3.drop_184750M.length_250M"

PERMIT_LOG = CASE_DIR / "result" / "l1pref" / f"{TRACE_TAG}-ligra-cf-footprint-l1pref-1core.log"
DISCARD_LOG = CASE_DIR / "result" / "discard_pgc" / f"{TRACE_TAG}-ligra-cf-footprint-discard-pgc-1core.log"
