...
TRACE="${TRACE:-/data2/zcq/champsim_traces_gap/bfs.kron-128B.champsimtrace.xz}"
TRACE_TAG="${TRACE_TAG:-bfs.kron-128B}"
N_WARM="${N_WARM:-50}"
N_SIM="${N_SIM:-100}"
MAX_EVENTS="${MAX_EVENTS:-0}"
SKIP_EXISTING="${SKIP_EXISTING:-1}"
BINARY_NAME="bfs.kron-128B-demand-tlb-pattern-1core"
