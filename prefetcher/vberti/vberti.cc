                                          ...
                                          access_type type, uint32_t metadata_in)
{
  ...
  berti = bigPicture[intern_->cpu].berti;
...
uint32_t vberti::prefetcher_cache_fill(champsim::address address, long set, long way,
