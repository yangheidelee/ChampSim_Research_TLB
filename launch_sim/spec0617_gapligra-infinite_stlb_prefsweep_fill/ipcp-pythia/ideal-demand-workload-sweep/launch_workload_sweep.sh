...
if [ -z "$SELECT_TRACE_JSON" ]; then
    ...
    DEFAULT_SELECT_TRACE_JSON="${PREFSWEEP_ROOT}/stlb_mpki_gt_1.0_selected_traces_qmm_parsec.json"
...
if [ "${#TRACE_FILES[@]}" -eq 0 ]; then
    echo "[ERROR] No SPEC06/SPEC17/GAP/Ligra/QMM/PARSEC trace files found in: $TRACE_DIRS"
