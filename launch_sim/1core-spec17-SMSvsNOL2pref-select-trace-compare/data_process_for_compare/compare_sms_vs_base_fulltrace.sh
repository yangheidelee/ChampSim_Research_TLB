...
BASE_CSV_DEFAULT="${CHAMPSIM_ROOT}/csv_figure/${COMPARE_TAG}/${FLOW_TAG}/1core-spec17-nol2pref-workload-sweep/nol2pref_benchmark_agg.csv"
SMS_CSV_DEFAULT="${CHAMPSIM_ROOT}/csv_figure/${COMPARE_TAG}/${FLOW_TAG}/1core-spec17-sms-workload-sweep/sms_benchmark_agg.csv"
