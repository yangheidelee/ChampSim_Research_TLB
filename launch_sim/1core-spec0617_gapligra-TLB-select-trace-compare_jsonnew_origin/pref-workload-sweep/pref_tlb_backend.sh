...
MPKI_FIG_TITLE="pref selected STLB MPKI"
DRAM_PKI_FIG_TITLE="pref selected DRAM RQ read requests PKI"
DRAM_SUMMARY_SHARE_FIG_TITLE="pref selected DRAM RQ read traffic summary share"
DRAM_DETAIL_SHARE_FIG_TITLE="pref selected DRAM RQ read traffic detail share"
STLB_PTW_DRAM_TOUCH_SHARE_FIG_TITLE="pref selected STLB miss PTW DRAM touch share"
...
if [ "$SELECT_TRACE_JSON" = "ALL" ] || [ "$SELECT_TRACE_JSON" = "FULL" ] || [ "$SELECT_TRACE_JSON" = "NONE" ]; then
    ...
    MPKI_FIG_TITLE="pref full-trace STLB MPKI"
    DRAM_PKI_FIG_TITLE="pref full-trace DRAM RQ read requests PKI"
    DRAM_SUMMARY_SHARE_FIG_TITLE="pref full-trace DRAM RQ read traffic summary share"
    DRAM_DETAIL_SHARE_FIG_TITLE="pref full-trace DRAM RQ read traffic detail share"
    STLB_PTW_DRAM_TOUCH_SHARE_FIG_TITLE="pref full-trace STLB miss PTW DRAM touch share"
