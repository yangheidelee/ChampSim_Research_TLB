...
CONFIG_LABEL=${CONFIG_LABEL:-pref}
...
DRAM_PKI_FIG_PNG="${OUT_DIR}/pref_dram_rq_read_pki.png"
DRAM_PKI_FIG_PDF="${OUT_DIR}/pref_dram_rq_read_pki.pdf"
DRAM_SUMMARY_SHARE_FIG_PNG="${OUT_DIR}/pref_dram_rq_summary_share.png"
DRAM_SUMMARY_SHARE_FIG_PDF="${OUT_DIR}/pref_dram_rq_summary_share.pdf"
DRAM_DETAIL_SHARE_FIG_PNG="${OUT_DIR}/pref_dram_rq_detail_share.png"
DRAM_DETAIL_SHARE_FIG_PDF="${OUT_DIR}/pref_dram_rq_detail_share.pdf"
STLB_PTW_DRAM_TOUCH_SHARE_FIG_PNG="${OUT_DIR}/pref_stlb_miss_ptw_dram_touch_share.png"
STLB_PTW_DRAM_TOUCH_SHARE_FIG_PDF="${OUT_DIR}/pref_stlb_miss_ptw_dram_touch_share.pdf"
...
FIG_TITLE="${CONFIG_LABEL} selected STLB miss causes"
MPKI_FIG_TITLE="${CONFIG_LABEL} selected STLB MPKI"
DRAM_PKI_FIG_TITLE="${CONFIG_LABEL} selected DRAM RQ read requests PKI"
DRAM_SUMMARY_SHARE_FIG_TITLE="${CONFIG_LABEL} selected DRAM RQ read traffic summary share"
DRAM_DETAIL_SHARE_FIG_TITLE="${CONFIG_LABEL} selected DRAM RQ read traffic detail share"
STLB_PTW_DRAM_TOUCH_SHARE_FIG_TITLE="${CONFIG_LABEL} selected STLB miss PTW DRAM touch share"
DONE_LABEL="${CONFIG_LABEL} selected CSV + figures"
if [ "$SELECT_TRACE_JSON" = "ALL" ] || [ "$SELECT_TRACE_JSON" = "FULL" ] || [ "$SELECT_TRACE_JSON" = "NONE" ]; then
    FIG_TITLE="${CONFIG_LABEL} full-trace STLB miss causes"
    MPKI_FIG_TITLE="${CONFIG_LABEL} full-trace STLB MPKI"
    DRAM_PKI_FIG_TITLE="${CONFIG_LABEL} full-trace DRAM RQ read requests PKI"
    DRAM_SUMMARY_SHARE_FIG_TITLE="${CONFIG_LABEL} full-trace DRAM RQ read traffic summary share"
    DRAM_DETAIL_SHARE_FIG_TITLE="${CONFIG_LABEL} full-trace DRAM RQ read traffic detail share"
    STLB_PTW_DRAM_TOUCH_SHARE_FIG_TITLE="${CONFIG_LABEL} full-trace STLB miss PTW DRAM touch share"
    DONE_LABEL="${CONFIG_LABEL} full-trace CSV + figures"
fi
