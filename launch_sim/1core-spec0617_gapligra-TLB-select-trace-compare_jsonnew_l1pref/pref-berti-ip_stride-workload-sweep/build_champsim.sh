...
NUM_CORE=1
case "$CONFIG_TAG" in
    pref-ipcp-pythia-workload-sweep)
        DEFAULT_L1D_PREFETCHER=ipcp
        DEFAULT_L2C_PREFETCHER=pythia
        ;;
    pref-berti-no-workload-sweep)
        DEFAULT_L1D_PREFETCHER=berti
        DEFAULT_L2C_PREFETCHER=no
        ;;
    pref-berti-ip_stride-workload-sweep)
        DEFAULT_L1D_PREFETCHER=berti
        DEFAULT_L2C_PREFETCHER=ip_stride
        ;;
    pref-sms-pythia-workload-sweep)
        DEFAULT_L1D_PREFETCHER=sms
        DEFAULT_L2C_PREFETCHER=pythia
        ;;
    *)
        DEFAULT_L1D_PREFETCHER=berti
...
L1I_PREFETCHER=${L1I_PREFETCHER:-next_line}
L1D_PREFETCHER=${L1D_PREFETCHER:-$DEFAULT_L1D_PREFETCHER}
L2C_PREFETCHER=${L2C_PREFETCHER:-$DEFAULT_L2C_PREFETCHER}
LLC_PREFETCHER=${LLC_PREFETCHER:-no}
LLC_REPLACEMENT=${LLC_REPLACEMENT:-drrip}
...
BINARY_NAME="tlb-pref-${L1D_PREFETCHER}-${L2C_PREFETCHER}-${NUM_CORE}core"
