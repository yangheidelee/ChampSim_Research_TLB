#ifndef PREFETCHER_STLB_ASP_H
#define PREFETCHER_STLB_ASP_H
...
class asp : public champsim::modules::stlb_prefetcher
{
public:
...
private:
  ...
  static constexpr uint8_t STABILITY_THRESHOLD = 2;
  ...
  uint64_t stride_matches_ = 0;
  uint64_t stride_mismatches_ = 0;
  uint64_t stable_predictions_ = 0;
